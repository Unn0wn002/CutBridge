...
_STRINGS = {
    "EN": {
        ...
        "per_pass_formats": "Per-Pass Formats",
        "beauty": "Beauty",
        "line": "Line",
        "shadow": "Shadow",
        "depth": "Depth",
        ...
        "diagnostic_what": "What: {value}",
        "diagnostic_why": "Why: {value}",
        "diagnostic_continue": "Can I continue? {value}",
        "support_code": "Support code: {value}",
        "fix": "Fix: {value}",
    ...
    "JA": {
        ...
        "diagnostic_what": "内容: {value}",
        "diagnostic_why": "理由: {value}",
        "diagnostic_continue": "続行できますか？ {value}",
        "support_code": "サポートコード: {value}",
        "fix": "対処: {value}",
...
_ISSUES_JA = {
    ...
    "LINE_OUTPUT_UNAVAILABLE": ("Lineが有効ですが、現在の設定ではFreestyle出力を生成できません。", "Freestyleと「As Render Pass」を有効にするか、Lineを無効にしてください。"),
    "DEPTH_FORMAT_LOSSY": ("Depthが有効ですが、連番形式がOpenEXRではありません。", "正確なDepthデータが必要な場合はOpenEXRを使用してください。"),
